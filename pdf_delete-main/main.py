...
if __name__ == '__main__':
    ...
    output_folder = os.path.join(os.path.dirname(input_folder), os.path.basename(input_folder) + "_out_pdf")
    error_folder = os.path.join(os.path.dirname(input_folder), os.path.basename(input_folder) + "_error")
    #----------------------------------------------
    
    # Dicom Tags entfernen
    Removing.removing_tag(input_folder, output_folder,error_folder)
